...
<p align="center">
  <img src="assets/cli-preview.svg" alt="Agent Context Budget CLI preview" width="88%">
</p>
...
```bash
npx github:aolingge/agent-context-budget --path fixtures/good.txt --annotations
```

Generate SARIF:

```bash
npx github:aolingge/agent-context-budget --path fixtures/good.txt --sarif > results.sarif
```
...
- GitHub: https://github.com/aolingge/agent-context-budget
- Gitee: https://gitee.com/aolingge/agent-context-budget
