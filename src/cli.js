...
function help() {
  console.log(`agent-context-budget v0.1.1

Usage:
  agent-context-budget --path FILE
  agent-context-budget FILE --markdown
  agent-context-budget FILE --sarif > results.sarif
  agent-context-budget FILE --annotations
  agent-context-budget FILE --redact
...
try {
  ...
  console.error(`agent-context-budget: ${error.message}`)
  process.exit(2)
}
